...
CREATE TABLE IF NOT EXISTS unix_purchase_orders (
...
CREATE TABLE IF NOT EXISTS unix_po_details (
  id                 VARCHAR(36)    NOT NULL PRIMARY KEY,
  ...
  CONSTRAINT fk_pod_po FOREIGN KEY (po_id) REFERENCES unix_purchase_orders(id) ON DELETE CASCADE
);
